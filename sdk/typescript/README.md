...
> **Registry caution.** npm carries `aegis-latent-sdk` at `4.0.0`; this source tree is `4.1.2`. Installing from npm gets you different code from what this document describes. See [Release Status](../../docs/RELEASE_STATUS.md).
