...
**Source baseline:** `5.0.0` with fourteen synchronized anchors, **published 2026-09-16 on every surface except PyPI `aegis-latent-core`** (read back and recorded in `docs/RELEASE_STATUS.md` §1.0); `4.1.2` remains the most recent version published on *every* surface, recorded in §1.1
