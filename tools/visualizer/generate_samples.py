            ...
            "components": [
                {
                    ...
                    "status": "ok",
                    "detail": "12 replicas · serving 11.2k req/s",
                },
                {"name": "Audit ledger", "status": "ok", "detail": "1.84B nodes · chain VALID"},
                {
                    "name": "WAF (Aho-Corasick)",
                    "status": "ok",
                    "detail": "34 patterns · SIMD automata",
                },
                {
                    "name": "Rate limiter",
                    "status": "ok",
                    "detail": "lock-free token bucket · 41.2k buckets",
                },
                {
                    "name": "Rust extension",
                    "status": "ok",
                ...
                },
                {
                    ...
                    "status": "ok",
                    "detail": "FIPS 204 · 99.2% of nodes",
                },
                {
                    "name": "Redis (rate-limit cluster)",
                    "status": "warn",
                    "detail": "1 replica lagging 40ms",
                },
                {
                    "name": "Storage (Postgres)",
                    "status": "ok",
                    "detail": "primary + 2 read replicas",
                },
            ],
        },
        "runtime": {
            ...
            "providers": [
                {
                    "name": "OpenAI",
                    "requests": 924_102_223,
                    "p95_ms": 0.79,
                    "tokens_in": 5_204_881_004,
                    "tokens_out": 1_980_557_120,
                    "errors": 120_440,
                    "share": 50.1,
                },
                {
                    "name": "Anthropic",
                    "requests": 518_821_119,
                    "p95_ms": 0.91,
                    "tokens_in": 3_122_004_551,
                    "tokens_out": 1_244_119_882,
                    "errors": 77_400,
                    "share": 28.1,
                },
                {
                    "name": "Gemini",
                    "requests": 241_175_400,
                    "p95_ms": 0.88,
                    "tokens_in": 1_402_551_223,
                    "tokens_out": 612_004_117,
                    "errors": 51_200,
                    "share": 13.1,
                },
                {
                    "name": "OpenRouter",
                    "requests": 158_454_275,
                    "p95_ms": 1.04,
                    "tokens_in": 905_117_004,
                    "tokens_out": 388_240_660,
                    "errors": 66_100,
                    "share": 8.7,
                },
            ],
                ...
                "bundles": [
                    {
                        ...
                        "format": "SOC2",
                        "nodes": 40_021_550,
                        "chain_hash": "239c3a4aeb96…",
                        "signer": "pqc-ml-dsa",
                        "integrity": "VALID",
                        "ts": "2026-06-19T22:14:00Z",
                    },
                    {
                        "id": "a1f23be2",
                        "format": "HIPAA",
                        "nodes": 19_904_220,
                        "chain_hash": "71b9e4c0a2d1…",
                        "signer": "hmac-sha256",
                        "integrity": "VALID",
                        "ts": "2026-06-15T09:02:00Z",
                    },
                    {
                        "id": "cf90a7d4",
                        "format": "SOC2",
                        "nodes": 85_500_119,
                        "chain_hash": "0ea4477122ab…",
                        "signer": "pqc-ml-dsa",
                        "integrity": "VALID",
                    ...
                    },
                    {
                        ...
                        "format": "HIPAA",
                        "nodes": 12_004_900,
                        "chain_hash": "c41a9be07f23…",
                        "signer": "pqc-ml-dsa",
                        "integrity": "VALID",
                        "ts": "2026-05-20T11:40:00Z",
                    },
                ],
            },
            "performance": {
                "rust_mmr_speedup": 2.87,
                "hotpath_p50_us": 77,
                "hotpath_p99_us": 132,
                "added_p99_ms": 1.06,
                "bench": [
...
def _threat_presets() -> list[dict]:
    ...
    try:
        ...
        return [
            {"id": p["id"], "label": p["label"], "expect": p["expect"], "text": p["text"]}
...
def inject(template: str, bootstrap: dict, page: str) -> str:
    ...
    if anchor not in template:
        raise SystemExit(
            "Template anchor not found — did static/index.html change its main <script> header?"
        )
...
def main() -> None:
    ...
    for i, page in enumerate(PAGES, start=1):
        (OUT_DIR / f"{i:02d}-{page}.html").write_text(
            inject(template, bootstrap, page), encoding="utf-8"
        )
