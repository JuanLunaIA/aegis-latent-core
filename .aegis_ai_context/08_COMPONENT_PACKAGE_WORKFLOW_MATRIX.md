...
| `typescript-sdk` | [`sdk/typescript/package.json`](../sdk/typescript/package.json) `version` | npm package `aegis-latent-sdk` | npm still carries `4.0.0` as of the 2026-09-03 readback; the `4.1.1` publish step failed. Source metadata is never publication evidence. |
