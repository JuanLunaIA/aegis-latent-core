...
3. Classify statements as **published v3.1.0**, **current-main unreleased**, **configuration-dependent**, **measured in a named environment**, or **externally unverified**.
4. Do not infer release status from `version = "3.1.0"`; the public v3.1.0 release and its immutable assets are the published baseline, while post-release current-main changes remain unreleased.
