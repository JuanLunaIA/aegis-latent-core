...
**Historical evidence baseline:** retained `v3.1.0` artifacts and measurements remain historical; `v4.1.2` source behavior is not attributed to that distribution
