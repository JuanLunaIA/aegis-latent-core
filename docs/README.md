...
**Release baseline:** checked-out source baseline `v5.0.1` with 14 synchronized anchors — published nowhere, read back 2026-09-21 (`docs/RELEASE_STATUS.md` §1.0a); the most recent published release is `v5.0.0`, 2026-09-16 on every surface except PyPI `aegis-latent-core` (§1.0), plus historical external observations
**Source baseline:** `5.0.1` with fourteen synchronized anchors, published nowhere (`docs/RELEASE_STATUS.md` §1.0a); immutable parent comparison `fdace8844568eb788216740b2cb5daf187d99d3b` has fourteen `4.0.0` anchors
