...
**Source baseline:** `5.0.0` with fourteen synchronized anchors, unpublished; immutable parent comparison `fdace8844568eb788216740b2cb5daf187d99d3b` has fourteen `4.0.0` anchors
