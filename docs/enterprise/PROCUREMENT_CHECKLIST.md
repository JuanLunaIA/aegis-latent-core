...
- [ ] **If evaluating an SDK from a registry, confirm the version.** PyPI carries `4.1.2`, matching source, but npm still carries `4.0.0`. Installing the SDK from npm gets you different code from the documentation.
