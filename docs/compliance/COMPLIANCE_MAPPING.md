# Compliance Contribution Map — Aegis Latent Core v5.0.1 Source Baseline
...
| Backpressure | Injected 2 ms `fsync` delay under 10k RPS offered load for 0.25 seconds preserved 2,500 durable records with valid chain | `tools/benchmarks/run_backpressure_stall.py`, `evidence/execution_2026-09-16/` | `MEASURED` / injected seam | p99 commit latency was 51.87478800007739 ms at source `88e01f0` (2026-09-16). The retained 836.3514210795984 ms figure in `evidence/execution_2026-08-20/` predates the group-commit engine and is superseded for current-state citation. Neither is production capacity, a storage SLO, or `dm-delay` equivalence. |
