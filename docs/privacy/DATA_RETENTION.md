# Data Retention and Privacy Boundaries — Aegis Latent Core v4.0.2 Source Baseline
...
**Historical evidence baseline:** retained `v3.1.0` schema and test statements remain historical and are not `v4.0.2` results
