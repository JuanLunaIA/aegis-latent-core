...
| Backpressure | `tools/benchmarks/run_backpressure_stall.py` | **Current, in tree:** [`evidence/execution_2026-09-16/`](../../evidence/execution_2026-09-16/) — 2,500 offered requests, p99 51.87 ms at `88e01f0`. **Superseded, in tree:** [`evidence/execution_2026-08-20/backpressure_stall_report.json`](../../evidence/execution_2026-08-20/backpressure_stall_report.json) — same parameters, p99 836.35 ms at `20fa011`, before group commit. **Retracted `v3.1.0` pair (`UC-018`), never in tree:** the 10k-request run with p99 1,189.89 ms is not citable — no committed artifact produces it | 2 ms *injected* `fsync` delay in all three; no production capacity claim from any. The 2026-08-20 run fsynced once per node (2,501 calls); the current one coalesces (200 calls) |
