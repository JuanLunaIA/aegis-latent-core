...
| Release contract | `python scripts/verify_release_contract.py --root . --tag v5.0.0` — checks the checked-out source, so the tag argument tracks the source baseline |
