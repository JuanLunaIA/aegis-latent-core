...
| Signed tag | `gitsign verify --certificate-identity ... v4.0.2` |
| Signed images | `cosign verify ghcr.io/juanlunaia/aegis-latent-core:4.0.2 ...` |
| Release contract | `python scripts/verify_release_contract.py --root . --tag v4.0.2` |
