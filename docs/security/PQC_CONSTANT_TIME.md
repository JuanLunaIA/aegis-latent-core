# ML-DSA-65 Timing Assessment — Aegis Latent Core v4.3.0 Source Baseline
...
**Historical evidence baseline:** retained `v3.1.0` timing evidence remains historical and is not a `v4.3.0` result
