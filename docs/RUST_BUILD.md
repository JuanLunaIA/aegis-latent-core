...
**Source baseline:** checked-out Rust and Python package metadata is synchronized at `v5.0.1` — **published nowhere**, read back 2026-09-21 (`docs/RELEASE_STATUS.md` §1.0a); `v5.0.0` is the most recent published release
