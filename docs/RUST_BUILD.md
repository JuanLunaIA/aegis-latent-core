...
**Source baseline:** checked-out Rust and Python package metadata is synchronized at `v5.0.1` — **published 2026-09-24 on every surface except PyPI `aegis-latent-core`**, read back the same day (`docs/RELEASE_STATUS.md` §1.0a); `v5.0.0` is the previous release
