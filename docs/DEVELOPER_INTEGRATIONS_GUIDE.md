...
**Status:** checked-out `v4.1.1` source baseline with fourteen synchronized anchors; signed tag, GitHub Release asset envelope, and GHCR gateway/dashboard objects were independently read back on 2026-08-28; PyPI/npm remain observed at `4.0.0` because trusted-publishing jobs were skipped
