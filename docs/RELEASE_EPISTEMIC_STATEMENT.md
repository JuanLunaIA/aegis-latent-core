...
**Source baseline:** `5.0.0`, fourteen synchronized anchors, published 2026-09-16 on every surface except PyPI `aegis-latent-core` (see [RELEASE_STATUS.md](RELEASE_STATUS.md) §1.0)
