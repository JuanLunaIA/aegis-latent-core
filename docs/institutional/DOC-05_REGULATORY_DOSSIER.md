...
**Source boundary:** checked-out source metadata is synchronized at `v4.1.2`; source metadata does not prove external tag, release, registry, OCI, deployment, compliance, or acceptance state
