...
**Source boundary:** checked-out source metadata is synchronized at `v5.0.0`; source metadata does not prove external tag, release, registry, OCI, deployment, compliance, or acceptance state
