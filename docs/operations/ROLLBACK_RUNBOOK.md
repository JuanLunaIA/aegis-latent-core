# Rollback Runbook — Aegis Latent Core v5.0.1 Source Baseline
...
**Historical evidence baseline:** retained `v3.1.0` evidence remains historical and is not a `v5.0.0` result
