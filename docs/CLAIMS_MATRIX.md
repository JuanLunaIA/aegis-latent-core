...
**Status:** Current `main` claim boundary after PR #99; `v3.1.0` remains the immutable release baseline
**Canonical language:** US English
**Last verified:** 2026-08-22 UTC
**Release baseline:** `v3.1.0` (the post-release capabilities identified below are not attributed to that tag)
