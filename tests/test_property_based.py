...
def test_ledger_integrity_property(state_id, entropy, payload, tenant_id):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        ledger = CryptographicAuditLedger(persistence_path=ledger_path, max_memory_nodes=100)
...
@given(val1=st.binary(min_size=1, max_size=1024), val2=st.binary(min_size=1, max_size=1024))
