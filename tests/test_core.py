...
class TestKahanSummation(unittest.TestCase):
    ...
    def test_nan_raises_value_error(self) -> None:
        ...
        with pytest.raises(ValueError) as ctx:
            kahan.add(float("nan"))
        self.assertIn("non-finite", str(ctx.value))
...
class TestCryptographicAuditLedger(unittest.TestCase):
    ...
    def test_tamper_detection(self) -> None:
        ...
        tampered = AuditNode(
            ...
            signature_scheme=node_to_tamper.signature_scheme,
            public_key=node_to_tamper.public_key,
            request_hash=node_to_tamper.request_hash,
            response_hash=node_to_tamper.response_hash,
            model=node_to_tamper.model,
            endpoint=node_to_tamper.endpoint,
            token_trail_count=node_to_tamper.token_trail_count,
    ...
    def test_null_byte_separator_prevents_injection(self) -> None:
        ...
        """
        self.create_ledger(self.temp_path)
    ...
    def test_state_id_with_null_byte_raises(self) -> None:
        ...
        self.assertIn("NULL", str(ctx.value))
    ...
    def test_wal_persistence_roundtrip(self) -> None:
        ...
        try:
            ...
            # Load fresh — use context manager to ensure handle is closed before unlink
            with self.create_ledger(persistence_path=path) as loaded:
