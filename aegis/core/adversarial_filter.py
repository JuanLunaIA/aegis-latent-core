...
class LLMGuardLocal:
    ...
    def __init__(self):
        ...
        self.weighted_patterns = {
            ...
            "exfiltration_signal": [
                re.compile(r"(print|show|echo) (your|the) (api[ _]key|secret|password|config)", re.IGNORECASE),
    ...
    def analyze_input(self, text: str) -> FilterResult:
        ...
        for pattern in self.critical_patterns:
            if pattern.search(full_text):
                ...
                return FilterResult(is_malicious=True, threat_type="CRITICAL_JAILBREAK", confidence=1.0)
        ...
        if score >= 0.7:
            threat = "AGGREGATED_ADVERSARIAL" if len(detected_types) > 1 else list(detected_types)[0]
            logger.warning(f"ADVERSARIAL_INPUT_DETECTED: Score {score:.2f}, Types: {detected_types}")
