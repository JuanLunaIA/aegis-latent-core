...
| Canal | CAC | Mezcla |
|---|---|---|
| founder_outbound | US$ 6,4 mil (ARS 9,7 M) | 50% |
| oss_inbound | US$ 2,0 mil (ARS 3,0 M) | 30% |
| partner_si | US$ 9,0 mil (ARS 13,7 M) | 15% |
| events_paid | US$ 18,0 mil (ARS 27,4 M) | 5% |
...
### D3.4 Sensibilidad: LTV/CAC por churn x ACV (MC 90%, CAC = máx(US$ 6,4 mil (ARS 9,7 M); 25% del ACV))
...
### D4 PESIMISTA — P&L / flujo de caja / balance (p=0,45)
...
### D4 BASE — P&L / flujo de caja / balance (p=0,40)
| Línea | AF1 | AF2 | AF3 | AF4 | AF5 |
|---|---|---|---|---|---|
...
### D4 OPTIMISTA — P&L / flujo de caja / balance (p=0,15)
| Línea | AF1 | AF2 | AF3 | AF4 | AF5 |
|---|---|---|---|---|---|
...
### D6.5 Tabla de descuentos (referencia = techo [AUDIT] de la banda semilla, US$ 15,00 M (ARS 22.792 M)) [MODEL]
