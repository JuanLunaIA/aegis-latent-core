...
**Release baseline:** `5.0.1` source line — published nowhere (`docs/RELEASE_STATUS.md` §1.0a); `5.0.0` is the most recent published release; see §1.0 for what was read back on each surface
