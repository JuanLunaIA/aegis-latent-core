...
**Release baseline:** `5.0.1` source line — published 2026-09-24 on every surface except PyPI `aegis-latent-core` (`docs/RELEASE_STATUS.md` §1.0a); `5.0.0` is the previous release; see §1.0 for what was read back on each surface
